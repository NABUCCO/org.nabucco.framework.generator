...
public class NabuccoToJavaRcpViewSearchTransformation extends NabuccoToJavaTransformation implements
     ...
     * @param context
     */
    public NabuccoToJavaRcpViewSearchTransformation(MdaModel<NabuccoModel> source, MdaModel<JavaModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<JavaModel> target,
        ...
        NabuccoToJavaVisitor visitor = new NabuccoToJavaRcpViewSearchVisitor(visitorContext);
