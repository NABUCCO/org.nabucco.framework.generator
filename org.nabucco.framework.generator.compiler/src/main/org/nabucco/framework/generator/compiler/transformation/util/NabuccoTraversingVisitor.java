 ...
 */
public abstract class NabuccoTraversingVisitor<A> extends GJVoidDepthFirst<A> {

    private NabuccoVisitorContext context;
     ...
     *            the visitor context
     */
    public NabuccoTraversingVisitor(NabuccoVisitorContext context) {
     ...
     */
    protected NabuccoVisitorContext getContext() {
        return this.context;
    }
