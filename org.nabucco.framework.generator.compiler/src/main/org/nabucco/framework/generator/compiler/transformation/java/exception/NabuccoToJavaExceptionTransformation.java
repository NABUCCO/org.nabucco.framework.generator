...
/**
 * NabuccoToJavaExceptionTransformation
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class NabuccoToJavaExceptionTransformation extends NabuccoToJavaTransformation {

    public NabuccoToJavaExceptionTransformation(MdaModel<NabuccoModel> source, MdaModel<JavaModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<JavaModel> target,
        ...
        NabuccoToJavaExceptionVisitor visitor = new NabuccoToJavaExceptionVisitor(visitorContext);
    ...
    protected void loadTemplates(NabuccoToJavaVisitorContext visitorContext) throws NabuccoTransformationException {
        try {
            ...
            JavaTemplate template = loader.loadTemplate(NabuccoJavaTemplateConstants.EXCEPTION_TEMPLATE);
            visitorContext.putTemplate(NabuccoJavaTemplateConstants.EXCEPTION_TEMPLATE, template);
        } catch (MdaExeception e) {
            throw new NabuccoVisitorException("Error loading java exception templates.", e);
        }
