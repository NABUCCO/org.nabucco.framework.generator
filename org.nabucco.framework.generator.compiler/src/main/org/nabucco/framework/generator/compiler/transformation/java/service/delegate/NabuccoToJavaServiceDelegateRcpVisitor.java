 ...
 */
public class NabuccoToJavaServiceDelegateRcpVisitor extends NabuccoToJavaVisitorSupport implements ViewConstants {
    ...
    private static String IMPORT_CLIENT_EXCEPTION = "org.nabucco.framework.base.facade.exception.client.ClientException";

    private static JavaAstMethodSignature SIGNATURE_SERVICE_OPERATION = new JavaAstMethodSignature(
            "serviceDelegateOperationRcpTemplate", "ServiceMsgTemplate", "ServiceSubContext");

    private String serviceName;

    /**
     * Creates a new {@link NabuccoToJavaServiceDelegateRcpVisitor} instance.
     * 
    ...
    private void addImports(CompilationUnitDeclaration unit) throws JavaModelException {
        ...
        factory.addImport(unit, producer.createImportReference(IMPORT_CLIENT_EXCEPTION));
