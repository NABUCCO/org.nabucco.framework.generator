...
/**
 * NabuccoPreCompilerSupport
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public abstract class NabuccoPreCompilerSupport extends GJVoidDepthFirst<NabuccoPreCompilerOptions>
        implements NabuccoPreCompiler {

    @Override
    public void preCompile(NabuccoModel model) throws NabuccoTransformationException {
        model.getUnit().accept(this, new NabuccoPreCompilerOptions());
    }
