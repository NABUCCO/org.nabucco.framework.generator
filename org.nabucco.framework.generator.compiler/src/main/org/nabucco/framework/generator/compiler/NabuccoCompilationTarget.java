...
public class NabuccoCompilationTarget {
     ...
     */
    public NabuccoCompilationTarget(MdaModel<NabuccoModel> model, String rootDirectory,
            String component) {
        if (model == null) {
     ...
     *            name of the appropriate NABUCCO component
     */
    public NabuccoCompilationTarget(List<MdaModel<NabuccoModel>> modelList, String rootDirectory,
            String component) {
        if (modelList == null) {
