...
/**
 * NabuccoToConfluenceDatatypeTransformation
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class NabuccoToConfluenceDatatypeTransformation extends NabuccoToConfluenceTransformation {
     ...
     */
    public NabuccoToConfluenceDatatypeTransformation(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
        ...
        NabuccoToConfluenceDatatypeVisitor visitor = new NabuccoToConfluenceDatatypeVisitor(visitorContext);
