 ...
 */
class NabuccoToJavaComponentLocatorVisitor extends NabuccoToJavaVisitorSupport implements
        ServerConstants {
    ...
    private static final JavaAstMethodSignature GET_INSTANCE = new JavaAstMethodSignature(
            SINGLETON_GETTER);
    ...
    public void visit(ComponentStatement nabuccoComponent, MdaModel<JavaModel> target) {
        ...
        try {
            ...
            JavaCompilationUnit unit = super
                    .extractAst(NabuccoJavaTemplateConstants.COMPONENT_LOCATOR_TEMPLATE);
            TypeDeclaration type = unit
                    .getType(NabuccoJavaTemplateConstants.COMPONENT_LOCATOR_TEMPLATE);
            ...
            this.configureJNDIName(interfaceName, pkg + PKG_SEPARATOR + interfaceName, type);
            this.configureSingleton(interfaceName, type);
            this.configureConstructor(interfaceName, type);

            // Javadoc
            NabuccoToJavaJavadocCreator.createJavadoc("Locator for "
                    + interfaceName + PKG_SEPARATOR, type);
     ...
     */
    private void configureJNDIName(String componentName, String pkg, TypeDeclaration type)
            throws JavaModelException {
        ...
        ((QualifiedNameReference) ((BinaryExpression) ((BinaryExpression) init.left).left).right).tokens[0] = componentName
                .toCharArray();

        Literal literal = JavaAstModelProducer.getInstance().createLiteral(pkg,
     ...
     * @throws JavaModelException
     */
    private void configureSingleton(String componentName, TypeDeclaration type)
            throws JavaModelException {
     ...
     * @throws JavaModelException
     */
    private void configureConstructor(String componentName, TypeDeclaration type)
            throws JavaModelException {
        ...
        JavaAstMethodSignature constructorSignature = new JavaAstMethodSignature(name,
     ...
     * @throws JavaModelException
     */
    private void changeGenerics(String componentName, List<Argument> arguments)
            throws JavaModelException {
