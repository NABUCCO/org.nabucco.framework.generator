...
/**
 * NabuccoToConfluenceAdapterVisitor
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceAdapterVisitor  extends NabuccoToConfluenceVisitor {
     ...
     */
    public NabuccoToConfluenceAdapterVisitor(NabuccoToConfluenceVisitorContext visitorContext) {
        super(visitorContext);
    }


    @Override
    public void visit( AdapterStatement nabuccoAdapter, MdaModel<ConfluenceModel> target) {

        super.visit(nabuccoAdapter, target);
        String datatypeName = nabuccoAdapter.nodeToken2.tokenImage;

        // Create and init a new page
        super.initPage(datatypeName,ADAPTER, target);
        
        // Print page header with package
        super.printPageHeader(NabuccoModelType.ADAPTER, datatypeName);
        ...
        super.printOriginalSignature(nabuccoAdapter, target);
        ...
        nabuccoAdapter.annotationDeclaration.accept(annotationVisitor, target);
        ...
        NabuccoToConfluenceAdapterDeclarationsVisitor declarationsVisitor = new NabuccoToConfluenceAdapterDeclarationsVisitor(
                this.getVisitorContext(), this.page);

        nabuccoAdapter.accept(declarationsVisitor, target);
