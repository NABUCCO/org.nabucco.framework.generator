 ...
 */
public class NabuccoToJavaRcpViewPickerVisitor extends NabuccoToJavaVisitorSupport implements ViewConstants {
    ...
    public void visit(EditViewStatement nabuccoEditView, MdaModel<JavaModel> target) {
        ...
        NabuccoToJavaRcpViewPickerHandlerVisitor visitorHandler = new NabuccoToJavaRcpViewPickerHandlerVisitor(
                super.getVisitorContext(), name, annotationDeclaration, this.fieldNameToTypeReference,
        ...
        NabuccoToJavaRcpViewPickerComparatorVisitor visitorComparatorHandler = new NabuccoToJavaRcpViewPickerComparatorVisitor(
                super.getVisitorContext(), annotationDeclaration, this.fieldNameToFieldTypeProperties);
    ...
    public void visit(DatatypeDeclaration nabuccoDatatype, MdaModel<JavaModel> target) {
        ...
        NabuccoToJavaDatatypeFieldCollectionVisitor visitor = new NabuccoToJavaDatatypeFieldCollectionVisitor(context);
        try {
            ...
            NabuccoDependencyResolver.getInstance().resolveDependency(context, pkg, importString).getModel().getUnit()
                    .accept(visitor, this.fieldNameToTypeReference);
        } catch (NabuccoTransformationException e) {
            throw new NabuccoVisitorException(e);
        }
        this.fieldNameToFieldTypeProperties.put(nabuccoDatatype.nodeToken2.tokenImage, this.fieldNameToTypeReference);
