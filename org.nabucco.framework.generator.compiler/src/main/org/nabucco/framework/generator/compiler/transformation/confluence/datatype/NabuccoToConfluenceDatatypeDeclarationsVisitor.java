...
/**
 * NabuccoToConfluenceDeclarationsVisitor
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceDatatypeDeclarationsVisitor extends NabuccoToConfluenceDeclarationVisitor {
     ...
     */
    public NabuccoToConfluenceDatatypeDeclarationsVisitor(NabuccoToConfluenceVisitorContext visitorContext,
    ...
    public void visit(BasetypeDeclaration n, MdaModel<ConfluenceModel> argu) {
        String assocStrategy = AssociationStrategyType.COMPOSITION.getName();
        if (mapper.hasAnnotation(n.annotationDeclaration, NabuccoAnnotationType.ASSOCIATION_STRATEGY)) {
            assocStrategy = mapper.mapToAnnotation(n.annotationDeclaration, NabuccoAnnotationType.ASSOCIATION_STRATEGY)
                    .getValue();
        }
        ...
        String transiencity = EMPTY;
        if (n.nodeOptional.node != null) {
            transiencity = n.nodeOptional.node.toString();
        }
        ...
        dataRow.addText(NabuccoToConfluenceTableSpaltenEnum.ASSOCIATION_STRATEGY, assocStrategy);
        dataRow.addText(NabuccoToConfluenceTableSpaltenEnum.MULTIPLICITY, multiplicity);
        dataRow.addText(NabuccoToConfluenceTableSpaltenEnum.TRANSIENT, transiencity);
    ...
    public void visit(EnumerationDeclaration n, MdaModel<ConfluenceModel> argu) {
        ...
        ConfluenceLocalAnchor nameAnchor = super.generateInfoPart(name, n, argu, true);
