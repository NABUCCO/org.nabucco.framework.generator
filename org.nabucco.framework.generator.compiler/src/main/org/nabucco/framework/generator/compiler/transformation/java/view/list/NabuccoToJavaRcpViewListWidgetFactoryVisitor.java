...
public class NabuccoToJavaRcpViewListWidgetFactoryVisitor extends NabuccoToJavaVisitorSupport {
    ...
    public void visit(ListViewStatement nabuccoListView, MdaModel<JavaModel> target) {
        ...
        try {
            ...
            JavaCompilationUnit unit = super.extractAst(NabuccoJavaTemplateConstants.LIST_VIEW_WIDGET_FACTORY_TEMPLATE);
            TypeDeclaration type = unit.getType(NabuccoJavaTemplateConstants.LIST_VIEW_WIDGET_FACTORY_TEMPLATE);
            ...
            throw new NabuccoVisitorException("Error during Java AST listview widgetfactory modification.", jme);
        } catch (JavaTemplateException te) {
            throw new NabuccoVisitorException("Error during Java template listview widgetfactory processing.", te);
        }
    }
