...
/**
 * NabuccoToConfluenceEnumerationTransformation
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceEnumerationTransformation extends NabuccoToConfluenceTransformation {

    /**
     * Creates a new {@link NabuccoToConfluenceDatatypeTransformation} instance.
     * 
     * @param source
     ...
     */
    public NabuccoToConfluenceEnumerationTransformation(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
        ...
        NabuccoToConfluenceEnumerationVisitor visitor = new NabuccoToConfluenceEnumerationVisitor(visitorContext);
