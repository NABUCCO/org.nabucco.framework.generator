...
/**
 * NabuccoToConfluenceComponentTransformation
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceComponentTransformation extends NabuccoToConfluenceTransformation {

    /**
     * Creates a new {@link NabuccoToConfluenceComponentTransformation} instance.
     * 
     * @param source
     ...
     */
    public NabuccoToConfluenceComponentTransformation(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
        ...
        NabuccoToConfluenceComponentVisitor visitor = new NabuccoToConfluenceComponentVisitor(visitorContext);
