 ...
 */
public class NabuccoToJavaRcpViewEditBrowserElementHandlerVisitor extends
     ...
     */
    public NabuccoToJavaRcpViewEditBrowserElementHandlerVisitor(
        ...
        try {
            ...
            if (leadingAnn != null) {
                ...
                TypeDeclaration type = unit
                        .getType(NabuccoJavaTemplateConstants.BROWSER_VIEW_ELEMENT_HANDLER_TEMPLATE);
     ...
     */
    private void changeMethodLoadFull(String viewName, String datatypePkg, String datatype,
        ...
        MethodDeclaration loadFull = (MethodDeclaration) javaFactory.getJavaAstType().getMethod(
                type, signature);
        ...
        loadFull.arguments[0].name = NabuccoTransformationUtility.firstToLower(datatype)
                .toCharArray();
    ...
    private void changeMethodCreateChildren(String viewName, String datatypePkg, String datatype,
        ...
        JavaAstMethodSignature signature = new JavaAstMethodSignature(CREATE_CHILDREN,
                EDIT_VIEW_MODEL, EDIT_VIEW_BROWSER_ELEMENT);
        ...
        // change type of first argument
        TypeReference element = jamp.createTypeReference(datatype + EDIT_VIEW_BROWSER_ELEMENT,
                false);
        ...
        ImportReference importReference = JavaAstModelProducer.getInstance().createImportReference(
                datatypePkg.replace(UI, UI_RCP) + PKG_SEPARATOR + MODEL_PACKAGE + PKG_SEPARATOR
                        + viewName + MODEL);
