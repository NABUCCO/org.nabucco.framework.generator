...
public interface PersistenceConstants extends XmlConstants {
    ...
    final String REF_ID_COLUMN = "ref_id";
    ...
    final String XPATH_JPA_EMBEDDABLE = "/entity-mappings/jpa/embeddable";
    ...
    final String XPATH_DISCRIMINATOR_COLUMN = "/entity-mappings/discriminator-column";

    final String XPATH_DISCRIMINATOR_VALUE = "/entity-mappings/discriminator-value";
