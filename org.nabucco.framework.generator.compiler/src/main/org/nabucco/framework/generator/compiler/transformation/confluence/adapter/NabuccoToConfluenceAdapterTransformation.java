...
/**
 * NabuccoToConfluenceAdapterTransformation
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceAdapterTransformation extends NabuccoToConfluenceTransformation {
     ...
     */
    public NabuccoToConfluenceAdapterTransformation(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
        ...
        NabuccoToConfluenceAdapterVisitor visitor = new NabuccoToConfluenceAdapterVisitor(visitorContext);
