...
public class NabuccoToJavaDatatypeTransformation extends NabuccoToJavaTransformation {
    ...
    public NabuccoToJavaDatatypeTransformation(MdaModel<NabuccoModel> source,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<JavaModel> target,
        ...
        NabuccoToJavaDatatypeVisitor visitor = new NabuccoToJavaDatatypeVisitor(visitorContext);
    ...
    protected void loadTemplates(NabuccoToJavaVisitorContext visitorContext)
        ...
        try {
            ...
            JavaTemplate template = loader.loadTemplate(NabuccoJavaTemplateConstants.DATATYPE_TEMPLATE);
            visitorContext.putTemplate(NabuccoJavaTemplateConstants.DATATYPE_TEMPLATE, template);
