 ...
 */
public class NabuccoToJavaRcpViewComboBoxLabelProviderVisitor extends NabuccoToJavaVisitorSupport implements
        ViewConstants, NabuccoJavaTemplateConstants {
     ...
     *            the name of the view from which the constructor is called.
     */
    public NabuccoToJavaRcpViewComboBoxLabelProviderVisitor(NabuccoToJavaVisitorContext visitorContext,
     ...
     */
    private void createComboBoxLabelProvider(MdaModel<JavaModel> target, AnnotationDeclaration annotationDeclaration,
            String comboBoxName) {
        JavaAstElementFactory javaFactory = JavaAstElementFactory.getInstance();
        String name = viewName + NabuccoTransformationUtility.firstToUpper(comboBoxName) + ViewConstants.LABEL_PROVIDER;
        ...
        try {
            JavaCompilationUnit unit = super.extractAst(COMMON_VIEW_COMBO_BOX_LABEL_PROVIDER_TEMPLATE);
            ...
            throw new NabuccoVisitorException("Error during Java AST combo box label provider modification.", jme);
        } catch (JavaTemplateException te) {
            throw new NabuccoVisitorException("Error during Java template combo box label provider processing.", te);
        }
    }
