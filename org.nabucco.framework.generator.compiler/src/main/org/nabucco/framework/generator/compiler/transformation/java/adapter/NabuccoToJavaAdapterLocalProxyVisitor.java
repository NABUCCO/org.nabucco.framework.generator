...
/**
 * NabuccoToJavaAdapterLocalProxyVisitor
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class NabuccoToJavaAdapterLocalProxyVisitor extends NabuccoToJavaVisitorSupport {
    ...
    /**
     * Creates a new {@link NabuccoToJavaAdapterLocalProxyVisitor} instance.
     * 
     * @param visitorContext
     *            the visitor context
     */
    public NabuccoToJavaAdapterLocalProxyVisitor(NabuccoToJavaVisitorContext visitorContext) {
    ...
    public void visit(AdapterStatement nabuccoAdapter, MdaModel<JavaModel> target) {
        ...
        try {
            // Load Template
            JavaCompilationUnit unit = super.extractAst(NabuccoJavaTemplateConstants.ADAPTER_LOCAL_PROXY_TEMPLATE);
            TypeDeclaration type = unit.getType(NabuccoJavaTemplateConstants.ADAPTER_LOCAL_PROXY_TEMPLATE);
