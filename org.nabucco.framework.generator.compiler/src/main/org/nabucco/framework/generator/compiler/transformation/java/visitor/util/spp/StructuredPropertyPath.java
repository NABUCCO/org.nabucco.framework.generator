...
public class StructuredPropertyPath extends StructuredPropertyPathSupport {
    ...
    public void visit(BasetypeDeclaration n, StructuredPropertyPathEntry argu) {
        argu.put(n.nodeToken3.tokenImage, new StructuredPropertyPathEntry(n, super
                .resolveImport(n.nodeToken1.tokenImage)));
        super.visit(n, argu);
    }

    @Override
    public void visit(DatatypeDeclaration n, StructuredPropertyPathEntry argu) {
        StructuredPropertyPathEntry structuredPropertyPathEntry = new StructuredPropertyPathEntry(
                n, super.resolveImport(((NodeToken) n.nodeChoice1.choice).tokenImage));
        argu.put(n.nodeToken2.tokenImage, structuredPropertyPathEntry);
        try {
            NabuccoDependencyResolver.getInstance().resolveDependency(getContext(),
                    getContext().getPackage(),
                    super.resolveImport(((NodeToken) n.nodeChoice1.choice).tokenImage)).getModel()
                    .getUnit().accept(this, structuredPropertyPathEntry);
    ...
    public void visit(EnumerationDeclaration n, StructuredPropertyPathEntry argu) {
        argu.put(n.nodeToken2.tokenImage, new StructuredPropertyPathEntry(n, super
                .resolveImport(((NodeToken) n.nodeChoice1.choice).tokenImage)));
        super.visit(n, argu);
    }
