...
/**
 * NabuccoToJavaServiceRemoteInterfaceVisitor
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
class NabuccoToJavaServiceRemoteInterfaceVisitor extends NabuccoToJavaVisitorSupport implements ServerConstants {

    /**
     * Creates a new {@link NabuccoToJavaServiceRemoteInterfaceVisitor} instance.
     * 
     * @param visitorContext
     *            the visitor context
     */
    public NabuccoToJavaServiceRemoteInterfaceVisitor(NabuccoToJavaVisitorContext visitorContext) {
    ...
    public void visit(ServiceStatement nabuccoService, MdaModel<JavaModel> target) {
        ...
        String remoteName = interfaceName + REMOTE;
        ...
        try {
            // Load Template
            JavaCompilationUnit unit = super.extractAst(NabuccoJavaTemplateConstants.SERVICE_REMOTE_INTERFACE_TEMPLATE);
            TypeDeclaration type = unit.getType(NabuccoJavaTemplateConstants.SERVICE_REMOTE_INTERFACE_TEMPLATE);
