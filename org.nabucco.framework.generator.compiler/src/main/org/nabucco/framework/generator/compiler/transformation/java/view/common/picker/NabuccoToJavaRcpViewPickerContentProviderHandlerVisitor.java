...
public class NabuccoToJavaRcpViewPickerContentProviderHandlerVisitor extends
        NabuccoToJavaVisitorSupport implements NabuccoJavaTemplateConstants, ViewConstants {
    ...
    private void createPickerContentProvider(String name, AnnotationDeclaration annotations,
        ...
        try {
            ...
            JavaCompilationUnit unit = super
                    .extractAst(EDIT_VIEW_PICKER_CONTENT_PROVIDER_HANDLER_TEMPLATE);
            TypeDeclaration type = unit.getType(EDIT_VIEW_PICKER_CONTENT_PROVIDER_HANDLER_TEMPLATE);
