...
public interface CollectionConstants extends JavaConstants {
    ...
    final String NABUCCO_LIST_IMPL = "NabuccoListImpl";

    final String NABUCCO_SET = "NabuccoSet";

    final String NABUCCO_SET_IMPL = "NabuccoSetImpl";

    final String NABUCCO_MAP = "NabuccoMap";

    final String NABUCCO_MAP_IMPL = "NabuccoMapImpl";
    ...
    final String IMPORT_NABUCCO_LIST_IMPL = "org.nabucco.framework.base.facade.datatype.collection.NabuccoListImpl";

    final String IMPORT_NABUCCO_SET = "org.nabucco.framework.base.facade.datatype.collection.NabuccoSet";

    final String IMPORT_NABUCCO_SET_IMPL = "org.nabucco.framework.base.facade.datatype.collection.NabuccoSetImpl";

    final String IMPORT_NABUCCO_MAP = "org.nabucco.framework.base.facade.datatype.collection.NabuccoMap";

    final String IMPORT_NABUCCO_MAP_IMPL = "org.nabucco.framework.base.facade.datatype.collection.NabuccoMapImpl";
