...
public abstract class NabuccoVisitor<M extends MdaModel<? extends ModelImplementation>, C extends NabuccoVisitorContext>
    ...
    protected String resolveImport(String type) {
        ...
        for (String nabuccoImport : this.getVisitorContext().getImportList()) {
        ...
        if (importString == null) {
            importString = this.getVisitorContext().getPackage() + PKG_SEPARATOR + type;
        }
        return importString;
    }

    /**
     * Getter for the component name defined by model type and modifier.
     * 
     * @param modelType
     *            the model type
     * @param modifier
     ...
     */
    protected String getComponentName(NabuccoModelType modelType, NabuccoModifierType modifier)
            throws NabuccoVisitorException {
    ...
    public String getComponentName(NabuccoClientType type) {
        ...
        StringBuilder path = new StringBuilder();
        path.append(NabuccoCompilerSupport.getParentComponentName(this
