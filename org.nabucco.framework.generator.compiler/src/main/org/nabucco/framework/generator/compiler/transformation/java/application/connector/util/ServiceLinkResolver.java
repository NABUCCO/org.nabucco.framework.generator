...
public class ServiceLinkResolver extends TraversingNabuccoToJavaVisitor<ServiceLinkDeclaration> {
     ...
     *            the service link
     */
    public ServiceLinkResolver(ApplicationStatement nabuccoApplication,
    ...
    public void resolve(ServiceLinkDeclaration serviceLink) {
        ...
        this.annotations = NabuccoAnnotationMapper.getInstance().mapToAnnotations(
                serviceLink.annotationDeclaration);
    }
