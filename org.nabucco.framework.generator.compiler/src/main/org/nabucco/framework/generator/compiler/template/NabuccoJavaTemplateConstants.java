...
public interface NabuccoJavaTemplateConstants extends JavaTemplateConstants {
    ...
    final String SERVICE_COMPONENT_DELEGATE_FACTORY_PROVIDER_TEMPLATE = SERVICE
            + DELEGATE + FACTORY + TEMPLATE;
    ...
    final String EDIT_VIEW_PICKER_CONTENT_PROVIDER_TEMPLATE = EDIT
            + VIEW + "PickerContentProvider" + TEMPLATE;
    ...
    final String COMMON_VIEW_COMBO_BOX_LABEL_PROVIDER_TEMPLATE = COMMON
            + VIEW + "ComboBoxLabelProvider" + TEMPLATE;

    final String COMMON_VIEW_COMBO_BOX_CONTENT_PROVIDER_TEMPLATE = COMMON
            + VIEW + "ComboBoxContentProvider" + TEMPLATE;

    final String COMMON_VIEW_COMBO_BOX_HANDLER_TEMPLATE = COMMON
            + VIEW + "ComboBoxHandler" + TEMPLATE;

    final String BROWSER_VIEW_ELEMENT_TEMPLATE = BROWSER + VIEW + "Element" + TEMPLATE;

    final String BROWSER_VIEW_ELEMENT_HANDLER_TEMPLATE = BROWSER
            + VIEW + "Element" + HANDLER + TEMPLATE;

    final String BROWSER_VIEW_LIST_ELEMENT_TEMPLATE = BROWSER + VIEW + LIST + "Element" + TEMPLATE;

    final String BROWSER_VIEW_LIST_ELEMENT_HANDLER_TEMPLATE = BROWSER
            + VIEW + LIST + "Element" + HANDLER + TEMPLATE;
