...
/**
 * NabuccoToJavaAdapterVisitorSupport
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
final class NabuccoToJavaAdapterVisitorSupport implements ServerConstants {

    /**
     * Private constructor must not be invoked.
     */
    private NabuccoToJavaAdapterVisitorSupport() {
    }

    /**
     * Creates the AdapterInterface operation
     * <p/>
     ...
     */
    public static JavaAstContainter<MethodDeclaration> createAdapterInterfaceOperation(String serviceName,
        ...
        // Extract method
        MethodDeclaration method = extractMethod(type, ADAPTER_INTERFACE_OPERATION);
        ...
        // AdapterResponse
        TypeReference adapterResponse = JavaAstModelProducer.getInstance().createTypeReference(serviceName, false);
        methodFactory.setReturnType(method, adapterResponse);
