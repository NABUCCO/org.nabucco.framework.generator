...
/**
 * NabuccoToConfluenceMessageTransformation
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceMessageTransformation  extends NabuccoToConfluenceTransformation {
     ...
     */
    public NabuccoToConfluenceMessageTransformation(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
        ...
        NabuccoToConfluenceMessageVisitor visitor = new NabuccoToConfluenceMessageVisitor(visitorContext);
