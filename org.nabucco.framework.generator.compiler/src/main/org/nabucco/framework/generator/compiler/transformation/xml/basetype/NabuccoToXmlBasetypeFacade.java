...
public class NabuccoToXmlBasetypeFacade {
     ...
     *            the component name
     */
    public void createOrmBasetypeFragments(MdaModel<NabuccoModel> source,
            MdaModel<XmlModel> target, NabuccoToXmlVisitorContext visitorContext,
            String componentName) {
        
        NabuccoToXmlBasetypeOrmVisitor visitor = new NabuccoToXmlBasetypeOrmVisitor(
                new NabuccoToXmlVisitorContext(visitorContext), componentName);
