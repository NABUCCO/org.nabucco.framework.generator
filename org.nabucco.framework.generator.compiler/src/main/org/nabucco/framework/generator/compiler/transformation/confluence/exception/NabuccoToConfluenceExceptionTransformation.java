...
/**
 * NabuccoToConfluenceExceptionTransformation
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class NabuccoToConfluenceExceptionTransformation extends NabuccoToConfluenceTransformation {

    /**
     * Creates a new {@link NabuccoToConfluenceExceptionTransformation} instance.
     * 
     * @param source
     ...
     */
    public NabuccoToConfluenceExceptionTransformation(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
    ...
    public void transformModel(MdaModel<NabuccoModel> source, MdaModel<ConfluenceModel> target,
        ...
        NabuccoToConfluenceExceptionVisitor visitor = new NabuccoToConfluenceExceptionVisitor(visitorContext);
