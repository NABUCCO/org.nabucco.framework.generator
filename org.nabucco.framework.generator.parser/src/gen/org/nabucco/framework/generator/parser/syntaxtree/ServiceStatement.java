...
public class ServiceStatement implements Node {
   ...
   public ServiceStatement(AnnotationDeclaration n0, NodeToken n1, NodeOptional n2, NodeToken n3, NodeToken n4, NodeOptional n5, NodeToken n6, NodeListOptional n7, NodeToken n8) {
   ...
   public ServiceStatement(AnnotationDeclaration n0, NodeOptional n1, NodeToken n2, NodeOptional n3, NodeListOptional n4) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
      ...
      nodeOptional = n1;
      if ( nodeOptional != null ) nodeOptional.setParent(this);
      nodeToken1 = new NodeToken("Service");
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
      nodeToken2 = n2;
      if ( nodeToken2 != null ) nodeToken2.setParent(this);
      nodeOptional1 = n3;
