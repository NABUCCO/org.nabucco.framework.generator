 ...
 * </PRE>
 */
public class DatatypeDeclaration implements Node {
   private Node parent;
   ...
   public DatatypeDeclaration(AnnotationDeclaration n0, NodeChoice n1, NodeOptional n2, NodeToken n3, NodeChoice n4, NodeToken n5, NodeToken n6, NodeToken n7) {
   ...
   public DatatypeDeclaration(AnnotationDeclaration n0, NodeChoice n1, NodeOptional n2, NodeChoice n3, NodeToken n4, NodeToken n5) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
      nodeChoice = n1;
      if ( nodeChoice != null ) nodeChoice.setParent(this);
