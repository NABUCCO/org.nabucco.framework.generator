 ...
 * </PRE>
 */
public class ExceptionParameterDeclaration implements Node {
   private Node parent;
   ...
   public ExceptionParameterDeclaration(AnnotationDeclaration n0, NodeToken n1, NodeToken n2, NodeToken n3, NodeToken n4) {
   ...
   public ExceptionParameterDeclaration(AnnotationDeclaration n0, NodeToken n1) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
      nodeToken = new NodeToken("private");
      if ( nodeToken != null ) nodeToken.setParent(this);
      nodeToken1 = new NodeToken("Parameter");
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
      nodeToken2 = n1;
      if ( nodeToken2 != null ) nodeToken2.setParent(this);
