 ...
 * </PRE>
 */
public class EditViewStatement implements Node {
   private Node parent;
   ...
   public EditViewStatement(AnnotationDeclaration n0, NodeToken n1, NodeToken n2, NodeToken n3, NodeToken n4, NodeListOptional n5, NodeToken n6) {
   ...
   public EditViewStatement(AnnotationDeclaration n0, NodeToken n1, NodeListOptional n2) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
      nodeToken = new NodeToken("public");
      if ( nodeToken != null ) nodeToken.setParent(this);
      nodeToken1 = new NodeToken("EditView");
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
      nodeToken2 = n1;
      if ( nodeToken2 != null ) nodeToken2.setParent(this);
