 ...
 * </PRE>
 */
public class CustomDeclaration implements Node {
   private Node parent;
   ...
   public CustomDeclaration(AnnotationDeclaration n0, NodeChoice n1, NodeToken n2, NodeToken n3, NodeToken n4, NodeToken n5) {
   ...
   public CustomDeclaration(AnnotationDeclaration n0, NodeChoice n1, NodeToken n2, NodeToken n3, NodeToken n4) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
      nodeChoice = n1;
      if ( nodeChoice != null ) nodeChoice.setParent(this);
