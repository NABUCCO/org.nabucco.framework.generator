 ...
 * </PRE>
 */
public class BasetypeStatement implements Node {
   private Node parent;
   ...
   public BasetypeStatement(AnnotationDeclaration n0, NodeToken n1, NodeToken n2, NodeToken n3, NodeOptional n4, NodeToken n5, NodeToken n6) {
   ...
   public BasetypeStatement(AnnotationDeclaration n0, NodeToken n1, NodeOptional n2) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
      nodeToken = new NodeToken("public");
      if ( nodeToken != null ) nodeToken.setParent(this);
      nodeToken1 = new NodeToken("Basetype");
      if ( nodeToken1 != null ) nodeToken1.setParent(this);
      nodeToken2 = n1;
      if ( nodeToken2 != null ) nodeToken2.setParent(this);
      nodeOptional = n2;
