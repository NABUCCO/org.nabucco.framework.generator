 ...
 * </PRE>
 */
public class ComponentStatement implements Node {
   private Node parent;
   ...
   public ComponentStatement(AnnotationDeclaration n0, NodeToken n1, NodeToken n2, NodeToken n3, NodeToken n4, NodeListOptional n5, NodeToken n6) {
   ...
   public ComponentStatement(AnnotationDeclaration n0, NodeToken n1, NodeListOptional n2) {
      annotationDeclaration = n0;
      if ( annotationDeclaration != null ) annotationDeclaration.setParent(this);
