...
public class NabuccoSearchViewGeneratorTest extends AbstractNabuccoGeneratorTest {
    ...
    private static final File SEARCH_VIEW_DIR_AUTHORIZATION_GROUP = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/search/group/");

    private static final File SEARCH_VIEW_DIR_AUTHORIZATION_USER = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/search/user/");

    private static final File SEARCH_VIEW_DIR_AUTHORIZATION_ROLE = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/search/role/");

    private static final File SEARCH_VIEW_DIR_AUTHORIZATION_PERMISSION = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/search/permission/");

    // Dynamiccode Search Views
    private static final File SEARCH_VIEW_DIR_DYNAMICCODE_CODE = new File(
            "../org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/ui/search/code/");

    private static final File SEARCH_VIEW_DIR_DYNAMICCODE_CODEGROUP = new File(
            "../org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/ui/search/codegroup/");
