...
public class NabuccoListViewGeneratorTest extends AbstractNabuccoGeneratorTest {
    ...
    private static final File LIST_VIEW_DIR_AUTHORIZATION_GROUP = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/list/group");

    private static final File LIST_VIEW_DIR_AUTHORIZATION_USER = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/list/user");

    private static final File LIST_VIEW_DIR_AUTHORIZATION_PERMISSION = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/list/permission");

    private static final File LIST_VIEW_DIR_AUTHORIZATION_ROLE = new File(
            "../org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/list/role");

    private static final File LIST_VIEW_DIR_DYNAMICCODE_CODEGROUP = new File(
            "../org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/ui/list/codegroup");

    private static final File LIST_VIEW_DIR_DYNAMICCODE_CODE = new File(
            "../org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/ui/list/code");
