...
public class NabuccoEditViewGeneratorTest extends AbstractNabuccoGeneratorTest {
    ...
    private static final File EDIT_VIEW_DIR_AUTHORIZATION_GROUP = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/edit/group");

    private static final File EDIT_VIEW_DIR_AUTHORIZATION_USER = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/edit/user");

    private static final File EDIT_VIEW_DIR_AUTHORIZATION_PERMISSION = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/edit/permission");

    private static final File EDIT_VIEW_DIR_AUTHORIZATION_ROLE = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/ui/edit/role");

    // Component Dynamic Code
    private static final File EDIT_VIEW_DIR_DYNAMICCODE_CODE = new File(
            "../../org.nabucco.framework.common.dynamiccode/org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/ui/edit/code");

    // Component Workflow Definition
    private static final File EDIT_VIEW_DIR_WORKFLOW_DEFINITION_CONDITION = new File(
            "../../org.nabucco.framework.workflow.definition/org.nabucco.framework.workflow.definition/src/nbc/org/nabucco/framework/workflow/definition/ui/edit/condition");

    private static final File EDIT_VIEW_DIR_WORKFLOW_DEFINITION_STATE = new File(
            "../../org.nabucco.framework.workflow.definition/org.nabucco.framework.workflow.definition/src/nbc/org/nabucco/framework/workflow/definition/ui/edit/state");

    private static final File EDIT_VIEW_DIR_WORKFLOW_DEFINITION_EFFECT = new File(
            "../../org.nabucco.framework.workflow.definition/org.nabucco.framework.workflow.definition/src/nbc/org/nabucco/framework/workflow/definition/ui/edit/effect");

    private static final File EDIT_VIEW_DIR_WORKFLOW_DEFINITION_TRANSITION = new File(
            "../../org.nabucco.framework.workflow.definition/org.nabucco.framework.workflow.definition/src/nbc/org/nabucco/framework/workflow/definition/ui/edit/transition");

    private static final File EDIT_VIEW_DIR_WORKFLOW_DEFINITION_WORKFLOW = new File(
            "../../org.nabucco.framework.workflow.definition/org.nabucco.framework.workflow.definition/src/nbc/org/nabucco/framework/workflow/definition/ui/edit/workflow");

    // Component Testautomation
    private static final File EDIT_VIEW_DIR_TESTAUTOMATION = new File(
            "../../org.nabucco.framework.testautomation/src/nbc/com/prodyna/nabucco/testautomation/ui/edit/script");
