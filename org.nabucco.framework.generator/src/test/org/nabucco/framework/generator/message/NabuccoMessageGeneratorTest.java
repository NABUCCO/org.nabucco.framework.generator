...
public class NabuccoMessageGeneratorTest extends AbstractNabuccoGeneratorTest {
    ...
    private static final File MESSAGE_DIR = new File(
            "../org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/facade/message");

    @Test
    public void testDynamicCodeMessageGeneration() throws Exception {
        super.generateDir(MESSAGE_DIR);
    }
