...
public class NabuccoServiceGeneratorTest extends AbstractNabuccoGeneratorTest {
    ...
    private static final File SERVICE_DIR_DYNAMICCODE_LINK = new File(
            "../../org.nabucco.framework.common.dynamiccode/org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/facade/service/link");

    private static final File SERVICE_DIR_DYNAMICCODE_MAINTAIN = new File(
            "../../org.nabucco.framework.common.dynamiccode/org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/facade/service/maintain");

    private static final File SERVICE_DIR_DYNAMICCODE_SEARCH = new File(
            "../../org.nabucco.framework.common.dynamiccode/org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/facade/service/search");

    private static final File SERVICE_DIR_DYNAMICCODE_PRODUCE = new File(
            "../../org.nabucco.framework.common.dynamiccode/org.nabucco.framework.common.dynamiccode/src/nbc/org/nabucco/framework/common/dynamiccode/facade/service/produce");

    private static final File SERVICE_DIR_AUTHORIZATION_LOGIN = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/facade/service/login");

    private static final File SERVICE_DIR_AUTHORIZATION_MAINTAIN = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/facade/service/maintain");

    private static final File SERVICE_DIR_AUTHORIZATION_SEARCH = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/facade/service/search");

    private static final File SERVICE_DIR_AUTHORIZATION_PRODUCE = new File(
            "../../org.nabucco.framework.common.authorization/org.nabucco.framework.common.authorization/src/nbc/org/nabucco/framework/common/authorization/facade/service/produce");
