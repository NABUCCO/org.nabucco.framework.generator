...
*/
package org.nabucco.framework.generator.base;
...
/**
 * NabuccoBasetypeGeneratorTest
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class NabuccoBasetypeGeneratorTest extends AbstractNabuccoGeneratorTest {

    private static final File BASETYPE_DIR = new File(
    ...
    @Test
    public void testBasetypeGeneration() throws Exception {
        this.generateDir(BASETYPE_DIR);
    }

    @Test
    public void testBaseExceptionGeneration() throws Exception {
        this.generateDir(BASE_EXCEPTION_DIR);
    }
