...
/**
 * ComponentLocalProxyTemplate
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
public class ComponentLocalProxyTemplate {

    private static final long serialVersionUID = 1L;

    private final ComponentLocalTemplate delegate;

    /**
     * Creates a new {@link ComponentLocalProxyTemplate} instance.
     * 
     * @param delegate
     *            the local component
     */
    public ComponentLocalProxyTemplate(ComponentLocalTemplate delegate) {
        if (delegate == null) {
