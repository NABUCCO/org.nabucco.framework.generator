...
/**
 * SearchViewModelTemplate
 * 
 * @author Silas Schwarz, PRODYNA AG
 */
public class SearchViewModelTemplate extends NabuccoComponentSearchViewModel implements
        NabuccoComponentSearchParameter {
    
    public static String TITLE = ID + "Title";

    public SearchViewModelTemplate(String viewId) {
